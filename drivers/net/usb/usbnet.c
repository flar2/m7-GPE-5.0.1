...
//++SSD_RIL:[PATCH] Enable debug buffer events for rmnet USB data
void
				     ...
				     struct net_device *net)
{
	...
	/*modified: skip EACCES case*/
	if (retval < 0 && ( retval != -EACCES ) ) {
#else//CONFIG_RIL_PCN001_HTC_QUEUE_URB_TO_DEFERRED_ANCHOR
	if (retval < 0) {
#endif//CONFIG_RIL_PCN001_HTC_QUEUE_URB_TO_DEFERRED_ANCHOR
...
#ifdef CONFIG_PM
#ifdef CONFIG_RIL_PCN001_HTC_QUEUE_URB_TO_DEFERRED_ANCHOR
	/*always queue urb if we got EACCES*/
	if ( retval == -EACCES ) {
